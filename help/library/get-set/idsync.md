---
description: 访客ID服务函数idSyncByURL和idSyncByDataSource允许您在目标发布iFrame中手动实施ID同步。 VisitorAPI.js 版本 1.10 或更高版本中提供了这些函数。
keywords: 访客 ID 服务
...
访客ID服务函数idSyncByURL和idSyncByDataSource允许您在目标发布iFrame中手动实施ID同步。 这些功能在`VisitorAPI.js`版本1.10或更高版本中可用。
