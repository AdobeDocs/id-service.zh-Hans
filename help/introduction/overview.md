...
>[!NOTE]
>
> 您可能会看到对以前名称或缩写词的引用，如ECID、Marketing Cloud ID Service(MID)和访客ID Service。 这些服务涉及 [!UICONTROL Experience Cloud Identity Service]。 您还可能会看 [!UICONTROL 到Experience Platform Identity Service]。 澄清：
