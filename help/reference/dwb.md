...
要更新 [Data Workbench](https://experienceleague.adobe.com/docs/data-workbench/using/home.html) 以使用 ID 服务，请执行以下操作：

1. 找到当前[解码器组](https://experienceleague.adobe.com/docs/data-workbench/using/dataset/dataset-include-files/types-dataset-inc-files/c-text-file-dec-groups.html)配置文件。
