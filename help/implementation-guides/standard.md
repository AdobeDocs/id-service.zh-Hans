...
在动态标签管理 (DTM) 中作为工具添加 ID 服务并进行保存后，即可使用这些设置。您也可以通过单击 DTM Web 属性的“[!UICONTROL 已安装工具]”部分的齿轮图标来访问这些设置。
...
当来自[数据收集服务器](https://marketing.adobe.com/resources/help/en_US/aam/c_compcollect.html) (DCS) 的响应返回 MID 时，您的帐户已正确配置。The MID is returned as a key-value pair that uses this syntax: `d_mid: visitor Experience Cloud ID`. 在“[!UICONTROL 响应]”选项卡中查找 MID，如下所示。
