...
[动态标签管理](https://marketing.adobe.com/resources/help/en_US/dtm/) 允许您配置、部署和管理ID服务实例以及相关的解决方 [!DNL Experience Cloud] 案集成。 DTM 可帮助简化实施流程，因为它与 ID 服务和其他 Experience Cloud 解决方案深度集成在一起。只需添加和配置 Experience Cloud ID 工具并指定相关信息即可，例如：
...
* [快速开始视频](https://marketing.adobe.com/resources/help/en_US/dtm/jump-start-videos.html):演示如何执行基本DTM任务的一系列简短视频。
...
Customers must provide a CNAME or use `*.sc.omtrdc` for [regional data collection](https://marketing.adobe.com/resources/help/en_US/whitepapers/rdc/) (RDC). 请从您的 [!DNL Adobe] 顾问处获取具体的 RDC 设置。
