...
在设置UI以使用[!UICONTROL Opt-in]来收集同意时，应该将其配置为调用将挂接到[!UICONTROL Opt-in]的API，并通知其同意部分或所有Adobe CX Enterprise解决方案。 有关这些 API 的详细信息，请参阅[选择加入参考文档](https://experienceleague.adobe.com/docs/id-service/using/implementation/opt-in-service/api.html?lang=zh-Hans&lank=zh-Hans)。 周围的文档页面上还提供了有关选择加入的其他信息。
