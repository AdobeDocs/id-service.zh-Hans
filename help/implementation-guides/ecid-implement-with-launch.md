---
description: Adobe Experience Platform Launch 是用于设置、部署 Experience Cloud 身份标识服务，并将其与其他 Experience Cloud 解决方案集成的主要工具。
title: 使用 Launch 实施
...
Adobe Experience Platform 中的标记是用于设置、部署 Experience Cloud 身份标识服务和将其与您的其他 Experience Cloud 解决方案集成的主要工具。
